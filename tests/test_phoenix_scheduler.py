...
class PhoenixLiteSchedulerTests(unittest.TestCase):
    ...
    def test_deferred_tasks_reserve_future_source_capacity(self) -> None:
        scheduler = PhoenixLiteScheduler()
    ...
    def test_orbit_load_balances_planes_before_battery(self) -> None:
        ...
        self.assertEqual(scheduler.plane_load_by_plane, {1: 1.0, 2: 1.0})

    def test_plane_load_resets_each_scheduling_batch(self) -> None:
        scheduler = PhoenixLiteScheduler()
        scheduler.plane_load_by_plane[1] = 99.0
        ...
        assignment = assign_one(
            ...
            views=[
                ...
                view(2, sunlit=True, battery_j=1000.0, plane=2, slot=0),
            ],
            graph=ISLGraph({0: (1, 2), 1: (0,), 2: (0,)}),
            step_s=10,
        )
